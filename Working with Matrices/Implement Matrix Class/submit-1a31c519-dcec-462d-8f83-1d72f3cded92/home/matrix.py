...
#         d = self.g[1][1]
    ...
    def __sub__(self, other):
        ...
        # TODO - your code here
        if self.h!=other.h or self.w!=other.w :
            raise(ValueError,"can be implemented only for square matrix")
        else:
            subtraction = []
            for i in range(self.h):
                row = []
    ...
    def __mul__(self, other):
        ...
        product =[]
        if self.w != other.h:
            raise(ValueError, "mul can be implemented only if columns of first matrix and rows of other matrix are equal")
        else:
            ...
            for i in range(self.h):
                ...
                for j in range(other.w):
                    trans = other.T()
                    row.append(dot_product(self[i],trans[j]))
                product.append(row)
